...
You will need to install the peer cli binaries and this fabric-samples1 repository available. For more information
...
It is advised to have 3 console windows open; one to monitor the infrastructure and one each for MagnetoCorp and DigiBank. Once you've cloned the fabric-samples1 - change to the commercial-paper directory in each window. 

```
cd fabric-samples1/commercial-paper
```
...
```
cd fabric-samples1/commercial-paper/magentocorp
./magnetocorp.sh
```
...
```
cd fabric-samples1/commercial-paper/digibank
./digibank.sh
```
